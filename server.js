...
{
  var whitelist = [ "ecs", "auth", "author", "image", "pag", "page", "recommendation", "search", "user-activity", "web", "mini", "follow", "category-datasync", "social", "pwg", "user", "library", "event", "notification", "content", "cms", "report", "init","oasis" ];
  if( STAGE === "devo" ) {

...
{
  var whitelist = [ "ecs", "auth", "author", "image", "pag", "page", "pratilipi", "recommendation", "search", "user-activity", "web", "mini", "follow", "category-datasync", "social", "pwg", "user", "library", "event", "notification", "content", "cms" ];
